  ...
  return (
    <>
      <div 
        ...
        className="bg-neutral-900 rounded-[14px] sm:rounded-[20px] overflow-hidden shadow-lg border border-neutral-800/80 flex flex-col group transition-all duration-300 hover:border-neutral-700 relative cursor-pointer"
      >
